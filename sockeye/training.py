...
class TrainingModel(model.SockeyeModel):
    ...
    def _fit(self,
        ...
        validation_set_evaluation_and_checkpointing_overhead=0
        ...
        while True:
            ...
            validation_set_evaluation_and_checkpointing_overhead += eval_end_t - eval_start_t
        ...
        print('@@Validation_Set_Evaluation_and_Checkpointing_Time=', validation_set_evaluation_and_checkpointing_overhead)
